...
## types
convert_eval_to_int <- function(target_col){
...
new_book <- c(convert_eval_to_int(dataset[,6]))
new_text <- c(convert_eval_to_int(dataset[,7]))
new_video <- c(convert_eval_to_int(dataset[,8]))
new_live <- c(convert_eval_to_int(dataset[,10]))
new_console <- c(convert_eval_to_int(dataset[,9]))
